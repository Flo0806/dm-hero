...
- 🤖 **Connect Your AI (MCP)** - Let Claude, Cursor & co. build a whole campaign from a module: entities with cross-links, portraits, documents, groups, maps, encounters and sessions — every change previewed first
