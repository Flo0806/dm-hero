  ...
  <div class="auth-page">
    ...
    <div class="auth-container">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-headline-large font-weight-light">{{ $t('auth.resetPassword.title') }}</h1>
      ...
      <v-card v-if="!token" class="auth-card" elevation="0">
        <v-card-text class="pa-8 text-center">
          ...
          <h2 class="text-headline-small mb-2">{{ $t('auth.resetPassword.invalidLink') }}</h2>
      ...
      <v-card v-else-if="success" class="auth-card" elevation="0">
        <v-card-text class="pa-8 text-center">
          ...
          <h2 class="text-headline-small mb-2">{{ $t('auth.resetPassword.successTitle') }}</h2>
          <p class="text-body-medium text-medium-emphasis mb-6">
